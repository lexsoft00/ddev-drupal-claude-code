...
setup() {
  ...
  export GITHUB_REPO=lexsoft00/ddev-drupal-claude-code
  ...
  # Create a minimal Drupal-like structure for testing
  mkdir -p web
  echo "<?php // Drupal index" > web/index.php
...
health_checks() {
  ...
  assert_file_exists .claudeignore
